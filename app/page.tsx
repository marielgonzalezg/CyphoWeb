...
import { getUserIdLS } from "@/app/lib/session";
...
export default function Home() {
  ...
  useEffect(() => {
    ...
    const onAuthChange = (e: Event) => {
      ...
      if (!detail?.userId) router.replace("/login");
    };
        ...
        <div className="max-w-7xl mx-auto px-4 pb-16">
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="bg-gradient-to-br from-red-500 to-pink-400 rounded-3xl p-8 shadow-lg hover:shadow-xl transition-shadow text-white">
              ...
              <p className="text-sm opacity-90 mb-8">Estos son tus gastos de este mes:</p>
            ...
            {/* Card 3 */}
            <div className="bg-white rounded-3xl p-8 shadow-lg hover:shadow-xl transition-shadow">
              <h3 className="text-xl font-bold text-gray-800 mb-6">Alerta de gastos</h3>
              <p className="text-gray-700 leading-relaxed">
                Este mes tus gastos fueron más elevados de lo normal. Considera reducir gastos innecesarios.
              </p>
            </div>
          </div>
        </div>
